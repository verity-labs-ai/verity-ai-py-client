...
class Configuration:
    ...
    conf = verity_ai_pyc.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://chat.veritylabs.ai" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("verity_ai_pyc")
